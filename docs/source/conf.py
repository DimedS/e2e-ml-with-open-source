...
# e2e_ml_with_open_source documentation build
...
from e2e_ml_with_open_source import __version__ as release

# -- Project information -----------------------------------------------------

project = "e2e_ml_with_open_source"
author = "Kedro"
...
htmlhelp_basename = "e2e_ml_with_open_sourcedoc"
...
latex_documents = [
    (
        master_doc,
        "e2e_ml_with_open_source.tex",
        "e2e_ml_with_open_source Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "e2e_ml_with_open_source",
        "Project e2e_ml_with_open_source codebase.",
        "Data-Science",
    )
]
